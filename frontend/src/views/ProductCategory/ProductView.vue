  ...
  <div class="common-layout">
    <el-container>
      <el-header class="header">
        <img class="logo" src="https://picx.zhimg.com/v2-d6f44389971daab7e688e5b37046e4e4_720w.jpg?source=172ae18b" alt="">
        <el-menu mode="horizontal" :default-active="1">
          <el-menu-item index="1">管理员</el-menu-item>
          <el-menu-item index="2" @click="handleOut">退出登录</el-menu-item>
        </el-menu>
      </el-header>
          ...
          <div class="wrap-container">
            <div class="wrap-header">
              ...
              <div class="header-actions">
                ...
                <el-input v-model="searchForm.product_name" placeholder="请输入商品名称" style="width: 200px" clearable></el-input>
            ...
            <el-dialog v-model="dialogFormVisible" :title="dialogTitle" width="600">
              <el-form :model="formData" label-width="100px">
                ...
                <el-form-item label="单位">
                  <el-select v-model="formData.unit_id" placeholder="请选择单位" style="width: 100%">
                    <el-option v-for="item in unitList" :key="item.id" :label="item.unit_name" :value="item.id" />
                  </el-select>
                </el-form-item>
                <el-form-item label="规格">
                  <el-select v-model="formData.specification_id" placeholder="请选择规格" style="width: 100%">
                    <el-option v-for="item in specificationList" :key="item.id" :label="item.spec_name" :value="item.id" />
                  </el-select>
                </el-form-item>
...
const formData = reactive({
  ...
  specification_id: null as number | null,
  cost_price: 0,
  selling_price: 0,
  image_url: '',
  remark: '',
...
const handleImageUpload = async (file: any) => {
  try {
    const response = await uploadFile(file.raw || file)
    if (response.data.code === 2000) {
      formData.image_url = response.data.data.url
