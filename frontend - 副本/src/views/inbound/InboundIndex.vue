      ...
      <div class="detail-section">
        ...
        <el-table :data="details" border size="small">
          ...
          <el-table-column label="规格" prop="specification" min-width="120">
            <template #default="{ row }">
              <el-input v-if="dialogTitle === '新增入库'" v-model="row.specification" placeholder="规格" size="small"></el-input>
              <span v-else>{{ row.specification }}</span>
            </template>
          </el-table-column>
          <el-table-column label="单位" prop="unit_name" width="100">
            <template #default="{ row }">
              <el-input v-if="dialogTitle === '新增入库'" v-model="row.unit_name" placeholder="单位" size="small"></el-input>
